...
/**
 * Indiana Rules of Evidence Authority Source.
 *
 * Source: https://rules.incourts.gov/Content/evidence/rule{N}/current.htm
 * Citation: Ind. Evidence Rule 301 / Evid. R. 301
 */
#[AuthoritySource(
  id: 'laci_indiana:evidence',
  rootName: 'laci_indiana_rules_of_evidence',
  label: 'Indiana Rules of Evidence'
)]
class IndianaEvidence extends IndianaCourtRuleBase {
